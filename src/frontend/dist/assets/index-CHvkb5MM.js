...
const FileImage = createLucideIcon("file-image", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function NavBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 w-full bg-card border-b border-border/60 shadow-[0_2px_16px_black/30] backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 h-14 flex items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-accent flex items-center justify-center shadow-[0_0_10px_oklch(0.70_0.20_50/0.5)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "h-4 w-4 text-accent-foreground" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-base font-semibold text-foreground hidden sm:block", children: "WallX" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground hidden sm:block", children: "· वॉलपेपर गैलरी" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground hidden md:block text-center flex-1", children: "Premium wallpapers for your device · प्रीमियम वॉलपेपर" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2.5 py-1 rounded-full border border-accent/40 text-accent bg-accent/10 font-medium", children: "4K · 8K" }) })
  ] }) });
}
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/50 py-4 px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
...
function WallpaperCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      type: "button",
      "data-ocid": `wallpaper.item.${index2 + 1}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-video overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": `wallpaper.favorite_button.${index2 + 1}`,
              onClick: handleFavorite,
              "aria-label": isFavorite ? "Remove from favorites" : "Add to favorites",
              className: [
                "absolute top-2 right-2 p-2 rounded-full backdrop-blur-sm transition-smooth",
                isFavorite ? "bg-destructive/80 text-destructive-foreground" : "bg-foreground/20 text-foreground/70 hover:bg-foreground/40 hover:text-foreground"
              ].join(" "),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: `h-4 w-4 ${isFavorite ? "fill-white" : ""}` })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              "data-ocid": `wallpaper.download_button.${index2 + 1}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm font-medium text-foreground truncate leading-tight", children: wallpaper.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: wallpaper.titleHindi }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: wallpaper.categoryLabel
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground ml-auto", children: wallpaper.resolution.split(" ")[0] })
          ] })
        ] })
      ]
    }
...
function WallpaperModal({
  ...
  const handleDownload = () => {
    ...
    link.download = `${wallpaper.title.replace(/\s+/g, "-").toLowerCase()}.jpg`;
    link.click();
    ue.success("Download started!", { description: wallpaper.title });
  };
  const handleShare = async () => {
    const url = `${window.location.origin}?wallpaper=${wallpaper.id}`;
    try {
      await navigator.clipboard.writeText(url);
      ue.success("Link copied!", { description: "Share link in clipboard" });
    } catch {
          ...
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-video bg-muted", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-foreground/30 via-transparent to-transparent pointer-events-none" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col sm:flex-row sm:items-center gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-semibold text-foreground", children: wallpaper.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "border-accent/40 bg-accent/10 text-accent text-xs", children: wallpaper.categoryLabel })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: wallpaper.titleHindi }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-2 text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FileImage, { className: "h-3.5 w-3.5" }),
                      wallpaper.resolution
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: wallpaper.fileSize })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: [
                        ...
                        isFavorite ? "bg-destructive/20 border-destructive/50 text-destructive" : "bg-card border-border/60 text-muted-foreground hover:text-foreground hover:border-accent/50"
                      ].join(" "),
...
function FavoritesPage({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-card border-b border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-accent/10 via-transparent to-transparent pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 py-8 sm:py-10 flex flex-col sm:flex-row sm:items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-destructive/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-5 w-5 text-destructive fill-destructive" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-accent uppercase tracking-widest mb-0.5", children: "पसंदीदा संग्रह · Saved Collection" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-2xl sm:text-3xl font-semibold text-foreground leading-tight", children: [
                "My ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Favorites" })
              ] })
            ] })
          ] }),
          favoriteCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:ml-auto flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/60 border border-border/40 w-fit", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            favoriteWallpapers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-9 w-9 text-muted-foreground" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-1 -right-1 w-6 h-6 rounded-full bg-card border border-border flex items-center justify-center text-xs", children: "0" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground mb-1", children: "No favorites yet" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs leading-relaxed", children: "पसंदीदा जोड़ने के लिए किसी भी वॉलपेपर पर ❤ दबाएं" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Tap the heart on any wallpaper to save it here" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
            ...
            favoriteWallpapers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  favoriteWallpapers.length,
                  " wallpaper",
                  favoriteWallpapers.length !== 1 ? "s" : "",
                  " saved ·",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "पसंदीदा" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: favoriteWallpapers.map((wallpaper, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    WallpaperCard,
                    {
                      wallpaper,
...
function CategoryTabs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 overflow-x-auto scrollbar-hide pb-1 items-center", children: [
    CATEGORIES.map((cat) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: [
            ...
            isActive ? "bg-accent text-accent-foreground border-accent shadow-[0_0_12px_oklch(0.70_0.20_50/0.4)]" : "bg-card text-muted-foreground border-border/50 hover:text-foreground hover:border-accent/50"
          ].join(" "),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: cat.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: cat.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: cat.labelHindi })
          ]
        },
        cat.id
      );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "पसंद" }),
          favoriteCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-0.5 bg-accent/20 text-accent rounded-full px-1.5 py-0 text-xs", children: favoriteCount })
        ]
      }
    )
  ] });
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    if (query.trim()) {
      ...
      result = result.filter(
        (w) => w.title.toLowerCase().includes(q) || w.titleHindi.includes(q) || w.tags.some((t) => t.includes(q)) || w.categoryLabel.toLowerCase().includes(q)
      );
    }
    return result;
  ...
  const handleShare = async () => {
    ...
    try {
      if (navigator.share) {
        ...
        ue.success("लिंक कॉपी हुआ!", {
          description: "Share link copied to clipboard"
        });
        setTimeout(() => setShareState("idle"), 2500);
      }
    } catch {
      ue.error("Could not share wallpaper");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center gap-3 px-4 py-3 bg-card border-b border-border/50 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4 group-hover:-translate-x-0.5 transition-transform duration-200" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "वापस / Back" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-base font-semibold text-foreground truncate", children: wallpaper.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: wallpaper.titleHindi })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-foreground/20 to-transparent pointer-events-none sm:hidden" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 bg-card border-t border-border/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-3 pb-1 flex flex-wrap items-center gap-x-5 gap-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { className: "h-3.5 w-3.5 text-accent" }),
                  wallpaper.resolution
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                ...
                className: "flex items-center gap-1.5 text-xs text-muted-foreground",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(HardDrive, { className: "h-3.5 w-3.5 text-accent" }),
                  wallpaper.fileSize
                ]
              }
            ),
          ...
          wallpaper.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-1.5 flex items-center gap-1.5 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "h-3 w-3 text-muted-foreground/60 shrink-0" }),
            wallpaper.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-2 pb-4 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                className: [
                  ...
                  isFavorite ? "bg-destructive/20 border-destructive/50 text-destructive" : "bg-muted/40 border-border/60 text-muted-foreground hover:text-foreground hover:border-accent/50"
                ].join(" "),
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Heart,
                  {
            ...
            shareState === "copied" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "डाउनलोड · Download" })
                ]
              }
            )
          ] })
...
function GalleryPage({ onNavigate }) {
  ...
  const handleCategoryChange = reactExports.useCallback((cat) => {
    setCategory(cat);
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-card border-b border-border/50", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 py-8 sm:py-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-accent uppercase tracking-widest mb-2", children: "Premium Collection · प्रीमियम संग्रह" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground leading-tight", children: [
            "Your Perfect ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Wallpaper" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 max-w-xs", children: "Luxury cars, superheroes & 4K nature — all in one place." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row gap-3 items-start sm:items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CategoryTabs,
              {
                active: category,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:ml-auto w-full sm:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              SearchBar,
              {
                value: query,
                onChange: setQuery,
        ...
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              ...
              (query || category !== "all") && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-medium text-foreground", children: "No wallpapers found" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: "Try a different search term or category" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
            ...
            filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4",
                children: filtered.map((wallpaper, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  WallpaperCard,
                  {
                    wallpaper,
                    isFavorite: isFavorite(wallpaper.id),
...
function App() {
  const [page, setPage] = reactExports.useState("gallery");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    page === "gallery" ? /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryPage, { onNavigate: setPage }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FavoritesPage, { onNavigate: setPage }),
